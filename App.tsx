...
<<<<<<< HEAD
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          <button
            ...
            className="px-8 py-4 w-full sm:w-auto text-xl font-bold text-white rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-offset-2 focus:ring-offset-gray-900 bg-gray-600 hover:bg-gray-700 disabled:bg-gray-800 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100"
          >
            Clear
          </button>
        </div>
